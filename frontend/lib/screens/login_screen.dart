...
class LoginScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // If anonymous user lands back on login (e.g., accessed restricted route),
    // show a small banner explaining why they need to sign in.
    final bool showUpgradeBanner = user?.isAnonymous ?? false;

    return Scaffold(
      body: Stack(
        children: [
          // ── Background (decorative – excluded from semantics) ──
          Positioned.fill(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // ── Upgrade banner (shown when guest hits restricted route) ──
                    ...
                    Semantics(
                      ...
                      hint: 'Authenticate with your Google account to unlock all features',
                      child: SizedBox(
                    ...
                    Semantics(
                      ...
                      hint:
                          'Access Civic Chat, Election Results and Quiz without signing in. Some features require a Google account.',
                      child: SizedBox(
                        width: double.infinity,
                        height: 52,
...
class _FeatureRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: '${feature.label}: ${feature.available ? 'available' : 'requires sign-in'}',
      child: Padding(
